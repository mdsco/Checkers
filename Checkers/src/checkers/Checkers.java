...
public class Checkers extends JPanel implements ActionListener{
	...
	//Creates checkers based on CheckersGame2 matrix and places them on
	...
	public static JMenuBar createWindowMenu(Checkers mainPanel){
	...
	public static void confirmWindow(String message, Checkers mainPanel){
	...
	private static void createAndShowGui() {
		...
		frame.setJMenuBar(Checkers.createWindowMenu(mainPanel));
